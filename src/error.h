// Copyright 2011--2020 Rodolfo Schulz de Lima, Andre Maximo
//
 ...
 */
template< class T1, class T2 >
void print_errors(const T1 *ref, const T2 *res, const int& w, const int& h, const T1& thrld = (T1)1e-5)
{
    for (int i = 0; i < h; i++)
    {
        for (int j = 0; j < w; j++)
 ...
 */
template< class T1, class T2 >
void print_errors(const T1 *ref, const T2 *res, const int& ne, const T1& thrld = (T1)1e-5)
{
    for (int i = 0; i < ne; i++)
    {
        T1 a = (T1)(res[i]) - ref[i];
 ...
 */
template< class T >
void print_matrix(const T *res, const int& w, const int& h) 
{
    for (int i = 0; i < h; i++)
    {
 ...
 */
template< class T >
void print_vector(const T *res, const int& ne)
{
